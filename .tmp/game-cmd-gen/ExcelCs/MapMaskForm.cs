...
namespace Form
{
 ...
 set{
            ...
            public Data(int id,string name,int icon,List<int> texsName,int labId):base(id,name,icon,labId)
            {
            ...
            public void Reset(Data data)
            {
             ...
             this.labId = data.labId;
                ...
                {
        return new Data(sameId? id:idChain.GetId(),name,icon,texsName==null?new List<int>():new List<int>(texsName),labId);
                }
            ...
            public override  void BeforeGet()
            {
                ...
                MapMaskForm.beforeGetAction?.Invoke(this);
                   ...
                   private static Data _defaultData=new Data(0,"",0,null,0);
