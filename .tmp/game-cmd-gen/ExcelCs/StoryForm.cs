...
public static readonly int autoIdCnt=100;
        ...
        public static Action<Data,string,string> changeRandomseedAction;
 ...
 set{
                    ...
                    if(_DataById!=null&&_DatasHashSet.Contains(this))
                    {
                       ChangeRandomseed(this,_randomSeed,value); 
                    }
            ...
            public Data(int id,string name,string desc,string icon,string randomSeed)
            {
            ...
            public void Reset(Data data)
            {
             ...
             this.randomSeed = data.randomSeed;
                ...
                {
        return new Data(sameId? id:idChain.GetId(),name,desc,icon,randomSeed);
                }
...
foreach(var k in _DataById.Keys){ idChain.PopId(k); }
        ...
        public static Data GetDataByJo(JObject jo)
        {
            ...
            Data data=new Data(
                ...
                jo.SelectToken("randomSeed")==null?defaultData.randomSeed:jo.Get<string>("randomSeed")
                    );
        ...
        public static JObject GetJoByData(Data data)
        {
            ...
            jo.Set<string>("randomSeed",data.randomSeed);
         ...
         private static void AddChildren(Data superData)
        {
            ...
            public static void ChangeRandomseed(Data superData,string oldV,string newV)
            {
                if(superData is Data data)
                {

                changeRandomseedAction?.Invoke(data,oldV,newV);
                }
