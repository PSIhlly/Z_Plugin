...
namespace Form
{
    ...
    public static partial class CharacterProtoForm
    {
        [RuntimeInitializeOnLoadMethod(RuntimeInitializeLoadType.AfterAssembliesLoaded)]
        static void Register()
        {

                ProtoForm.childInitAction+=InitInternal;

        }

        private static bool inited;
        public static Z_Chain.Chain uidChain=>ProtoForm.uidChain;
        public static Action childInitAction;

        public partial class Data : ProtoForm.Data
        {
