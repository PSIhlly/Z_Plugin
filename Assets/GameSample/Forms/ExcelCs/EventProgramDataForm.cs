...
namespace Form
{
 ...
 set{
            ...
            public Data(int uid,string name,string code,List<string> zCode,List<int> zCodeMap,int paramCount,string returnValue,int labId):base(uid,name,code,zCode,zCodeMap,paramCount,returnValue)
            {
            ...
            public void Reset(Data data)
            {
             ...
             this.labId = data.labId;
                ...
                {
        return new Data(sameId? uid:uidChain.GetId(),name,code,zCode==null?new List<string>():new List<string>(zCode),zCodeMap==null?new List<int>():new List<int>(zCodeMap),paramCount,returnValue,labId);
                }
            ...
            public override  void BeforeGet()
            {
                ...
                EventProgramDataForm.beforeGetAction?.Invoke(this);
                   ...
                   private static Data _defaultData=new Data(0,"","",null,null,0,"",0);
