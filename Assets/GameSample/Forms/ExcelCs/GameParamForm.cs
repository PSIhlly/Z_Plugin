...
namespace Form
{
    ...
    public static partial class GameParamForm
    {
        ...
        return new Data(sameId? uid:uidChain.GetId(),name,valueType,min,v,max);
            ...
            {
                base.BeforeGet();
                GameParamForm.beforeGetAction?.Invoke(this);
            }
        }
...
ParamForm.RemoveData(uid);
         ...
         private static void AddChildren(ParamForm.Data superData)
        {
            ...
            public static void ChangeMin(ParamForm.Data superData,string oldV,string newV)
            {
                if(superData is Data data)
                {
            ...
            public static void ChangeV(ParamForm.Data superData,string oldV,string newV)
            {
                if(superData is Data data)
                {
            ...
            public static void ChangeMax(ParamForm.Data superData,string oldV,string newV)
            {
                if(superData is Data data)
                {
