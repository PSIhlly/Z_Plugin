...
private set{
            ...
            public Data(int id,string name,int icon,int labId,bool terrain,bool mObject,bool item,bool character,bool texture):base(id,name,icon,labId)
            {
            ...
            public void Reset(Data data)
            {
             ...
             this.texture = data.texture;
                ...
                {
        return new Data(sameId? id:idChain.GetId(),name,icon,labId,terrain,mObject,item,character,texture);
                }
            ...
            public override  void BeforeGet()
            {
                ...
                MapEraseForm.beforeGetAction?.Invoke(this);
                   ...
                   private static Data _defaultData=new Data(0,"",0,0,false,false,false,false,false);
        ...
        public static void InitInternal()
        {
            ...
            inited=true;  
                ...
                {10000001,new Data(10000001,"all erase",0,0,true,true,true,true,false)},

                {10000002,new Data(10000002,"texture only",0,0,false,false,false,false,true)},

                {10000003,new Data(10000003,"remain terrain",0,0,false,true,true,true,false)},
                ...
                _DatasHashSet=new HashSet<Data>();
                    ...
                    _DatasByLabid[0].Add(_DataById[10000001]);

                    _DatasByLabid[0].Add(_DataById[10000002]);

                    _DatasByLabid[0].Add(_DataById[10000003]);
