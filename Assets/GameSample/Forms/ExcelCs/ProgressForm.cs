...
public static readonly int autoUidCnt=100;
 ...
 set{
            ...
            public Data(int uid,int sceneId,Vector3 pos,int characterUid,List<int> bag,List<int> team,List<int> teamActive,Dictionary<string,EventTriggerForm.Data> events,ClipForm.Data dialogCache,Dictionary<int,List<string>> triggeredOnceEvts,bool notFirstTime,int blockProgramUid)
            {
             ...
             this.blockProgramUid = blockProgramUid;
                ...
                {
        return new Data(sameId? uid:uidChain.GetId(),sceneId,pos,characterUid,new List<int>(bag),new List<int>(team),new List<int>(teamActive),new Dictionary<string,EventTriggerForm.Data>(events),dialogCache,new Dictionary<int,List<string>>(triggeredOnceEvts),notFirstTime,blockProgramUid);
                }
            
        }

                   private static Data _defaultData=new Data(0,0,Vector3.zero,0,null,null,null,new Dictionary<string,EventTriggerForm.Data>(){},ClipForm.defaultData,new Dictionary<int,List<string>>(){},false,0);
