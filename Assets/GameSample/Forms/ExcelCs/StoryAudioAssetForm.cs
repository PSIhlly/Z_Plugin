...
namespace Form
{
    ...
    public static partial class StoryAudioAssetForm
    {
        ...
        static void Register()
        {
                ...
                AudioAssetForm.childInitAction+=InitInternal;


                AudioAssetForm.childRemoveAction+=RemoveChildren;
                AudioAssetForm.childAddAction+=AddChildren;
            

            AudioAssetForm.changeIdAction+=ChangeId;

            AudioAssetForm.changeNameAction+=ChangeName;

            AudioAssetForm.changePathAction+=ChangePath;

            AudioAssetForm.changeBytesAction+=ChangeBytes;

            AudioAssetForm.changeHashAction+=ChangeHash;

            AudioAssetForm.changeAssetAction+=ChangeAsset;

            AudioAssetForm.changeLabAction+=ChangeLab;
        ...
        public static Z_Chain.Chain idChain =>AudioAssetForm.idChain;
        ...
        public partial class Data : AudioAssetForm.Data
        {

            public Data(AudioAssetForm.Data data):base(data.id,data.name,data.path,data.bytes,data.hash,data.asset,data.lab)
            {
            }
        ...
        return new Data(sameId? id:idChain.GetId(),name,path,bytes,hash,asset,lab);
            ...
            {
                base.BeforeGet();
                StoryAudioAssetForm.beforeGetAction?.Invoke(this);
            }
        }
...
AudioAssetForm.RemoveData(id);
        ...
        public static void ClearAuto()
        {
         ...
         private static void RemoveChildren(AudioAssetForm.Data data)
        {
            Init();
            if(data is Data)
               RemoveData(data.id);      
        }
         private static void AddChildren(AudioAssetForm.Data superData)
        {
            Init();
            ...
            public static void ChangeId(AudioAssetForm.Data superData,int oldV,int newV)
            {
                if(superData is Data data)
                {
            ...
            public static void ChangeName(AudioAssetForm.Data superData,string oldV,string newV)
            {
                if(superData is Data data)
                {
            ...
            public static void ChangePath(AudioAssetForm.Data superData,string oldV,string newV)
            {
                if(superData is Data data)
                {
            ...
            public static void ChangeBytes(AudioAssetForm.Data superData,byte[] oldV,byte[] newV)
            {
                if(superData is Data data)
                {
            ...
            public static void ChangeHash(AudioAssetForm.Data superData,string oldV,string newV)
            {
                if(superData is Data data)
                {
            ...
            public static void ChangeAsset(AudioAssetForm.Data superData,object oldV,object newV)
            {
                if(superData is Data data)
                {
            ...
            public static void ChangeLab(AudioAssetForm.Data superData,string oldV,string newV)
            {
                if(superData is Data data)
                {
