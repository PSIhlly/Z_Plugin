...
namespace Form
{
    ...
    public static partial class StoryVideoAssetForm
    {
        ...
        static void Register()
        {
            ...
            VideoAssetForm.changeLabAction+=ChangeLab;
        ...
        public partial class Data : VideoAssetForm.Data
        {
            ...
            public Data(VideoAssetForm.Data data):base(data.id,data.name,data.path,data.bytes,data.hash,data.asset,data.lab)
            {
            }
...
VideoAssetForm.RemoveData(id);
         ...
         private static void AddChildren(VideoAssetForm.Data superData)
        {
            ...
            public static void ChangeLab(VideoAssetForm.Data superData,string oldV,string newV)
            {
                if(superData is Data data)
                {
