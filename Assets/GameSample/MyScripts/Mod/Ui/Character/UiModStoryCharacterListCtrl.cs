    ...
    public partial class UiModStoryCharacterListCtrl
    {
        ...
        bool TryGetCurrentLab(out LabForm.Data lab)
        {
            ...
            return model.labId.HasValue &&
                   ...
                   lab.belong == nameof(CharacterProductForm);
        }
        ...
        void RenameCurrentLab(string value)
        {
            ...
            var newLabId = LabForm.GetOrCreateDisplayName(value.Trim(), nameof(CharacterProductForm), oldLabId);
            ...
            {
                foreach (var data in CharacterProductForm.DataByUid.Values.ToList())
                {
