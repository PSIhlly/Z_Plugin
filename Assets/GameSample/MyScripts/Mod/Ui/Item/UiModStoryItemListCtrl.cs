    ...
    public partial class UiModStoryItemListCtrl
    {
        ...
        bool TryGetCurrentLab(out LabForm.Data lab)
        {
            ...
            return model.labId.HasValue &&
                   ...
                   lab.belong == nameof(ItemProductForm);
        }
        ...
        void RenameCurrentLab(string value)
        {
            ...
            var newLabId = LabForm.GetOrCreateDisplayName(value.Trim(), nameof(ItemProductForm), oldLabId);
            ...
            {
                foreach (var data in ItemProductForm.DataByUid.Values.ToList())
                {
    ...
    public partial class UiBigItemCtrl
    {
        ...
        public void Refresh()
        {
            ...
            if (model.data != null)
            {
                ...
                var tex = TexAssetForm.DataById.GetDv(model.data.iconTexName, null)
                    ?? TexAssetForm.DataById.GetDv(GlobalDefaultHelper.DefaultItemTexId, null)
