...
public class PlayData
{
    ...
    public PlayData()
    {
        ...
        progress = new ProgressForm.Data(1, 1, Vector3.zero, 0, new List<int>(), new List<int>(), new List<int>(),default, Z_Ui.Form.ClipForm.defaultData.Copy(),new Dictionary<int, List<string>>(), false,0);
    }
    public void Unload()
    {
