...
namespace Z_DataSystem.Form
{
    ...
    public static partial class VideoAssetForm
    {
        ...
        static void Register()
        {
            ...
            AssetForm.changeLabidAction+=ChangeLabid;
        ...
        public partial class Data : AssetForm.Data
        {
            ...
            public Data(AssetForm.Data data):base(data.id,data.name,data.path,data.bytes,data.hash,data.asset,data.labId)
            {
            }
...
AssetForm.RemoveData(id);
         ...
         private static void AddChildren(AssetForm.Data superData)
        {
            ...
            public static void ChangeLabid(AssetForm.Data superData,int oldV,int newV)
            {
                if(superData is Data data)
                {
