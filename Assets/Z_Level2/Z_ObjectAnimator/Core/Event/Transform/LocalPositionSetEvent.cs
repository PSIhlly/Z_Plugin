...
namespace Z_ObjectAnimator.Base
{
    ...
    public class LocalPositionSetEvent : Event
    {
        ...
        public LocalPositionSetEvent(Transform transform, Vector3 posOri, Vector3 pos,  float duration=0):base(duration)
        {
            _pos = pos;
        ...
        {
            _transform.localPosition = Vector3.Lerp(_posOri,_pos,1f*(_times+1)/_maxTimes);
            return base.Excute();
        }
        ...
        {
            base.ToStart();
            _transform.localPosition = _posOri;
        }
    }
}