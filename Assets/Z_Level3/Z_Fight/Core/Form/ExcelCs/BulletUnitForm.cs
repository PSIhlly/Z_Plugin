...
namespace Z_Fight.Form
{
 ...
 set{
            ...
            public Data(int uid,string name,int weaponBulletId,float rangeLast,int attackerUid,string prefabName,Vector3 pos,Vector3 euler,Vector3 scale,UpdateType updateType,List<int> collidingUnitUid,string extra):base(uid,name,prefabName,pos,euler,scale,updateType,collidingUnitUid,extra)
            {
        ...
        public static JObject GetJoByData(Data data)
        {
            ...
            jo.Set<int>("weaponBulletId",data.weaponBulletId);

            jo.Set<float>("rangeLast",data.rangeLast);

            jo.Set<int>("attackerUid",data.attackerUid);
