 ...
 set{
            ...
            public void Reset(Data data)
            {
             ...
             this.extra = data.extra;
                ...
                {
        return new Data(sameId? uid:uidChain.GetId(),name,fightUid,weaponBulletsId==null?new List<int>():new List<int>(weaponBulletsId),curWeaponBulletAid,cdRemain,magazineRemain,prefabName,pos,euler,scale,updateType,collidingUnitUid==null?new List<int>():new List<int>(collidingUnitUid),extra);
                }
