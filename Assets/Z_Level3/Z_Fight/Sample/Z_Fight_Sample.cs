...
public class Z_Fight_Sample : MonoBehaviour
{
    ...
    void Start()
    {
        FightManager.instance.Begin(FightData.GetDefault(prefabs, materials));
    ...
    public void Update()
    {
        ...
        ((FightUnit)FightManager.instance.unitDic[2]).SetTarget(1);
        main = FightManager.instance.unitDic[1].ins.transform;
        ...
        if (Input.GetKey(KeyCode.O))
            SaveAndLoad.Save("fight_data1", JsonConvert.SerializeObject(FightManager.instance.data.GetJsonData()));
