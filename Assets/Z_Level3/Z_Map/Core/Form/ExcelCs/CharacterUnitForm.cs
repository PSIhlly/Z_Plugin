...
namespace Z_Map.Form
{
 ...
 set{
            ...
            public Data(int uid,bool navEnabled,Vector3 destination,float speed,float alertDis,float pathDis,bool isMine,string name,string prefabName,Vector3 pos,Vector3 euler,Vector3 scale,UpdateType updateType,List<int> collidingUnitUid,string extra):base(uid,name,prefabName,pos,euler,scale,updateType,collidingUnitUid,extra)
            {
             ...
             this.extra = extra;
                ...
                {
        return new Data(sameId? uid:uidChain.GetId(),navEnabled,destination,speed,alertDis,pathDis,isMine,name,prefabName,pos,euler,scale,updateType,new List<int>(collidingUnitUid),extra);
                }
            
        }

                   private static Data _defaultData=new Data(0,false,Vector3.zero,0f,0f,0f,false,"","",Vector3.zero,Vector3.zero,Vector3.zero,UpdateType.ShowOnly,null,"");
