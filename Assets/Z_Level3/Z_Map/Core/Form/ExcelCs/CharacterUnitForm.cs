 ...
 set{
            ...
            public void Reset(Data data)
            {
             ...
             this.enteredScene = data.enteredScene;
                ...
                {
        return new Data(sameId? uid:uidChain.GetId(),navEnabled,destination,speed,alertDis,pathDis,isMine,name,prefabName,pos,euler,scale,updateType,collidingUnitUid==null?new List<int>():new List<int>(collidingUnitUid),extra,enteredScene);
                }
