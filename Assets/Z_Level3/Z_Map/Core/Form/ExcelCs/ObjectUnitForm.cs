...
namespace Z_Map.Form
{
 ...
 set{
            ...
            public Data(int uid,bool isObstacle,string name,string prefabName,Vector3 pos,Vector3 euler,Vector3 scale,UpdateType updateType,string extra):base(uid,name,prefabName,pos,euler,scale,updateType,extra)
            {
             ...
             this.extra = extra;
                ...
                {
        return new Data(sameId? uid:uidChain.GetId(),isObstacle,name,prefabName,pos,euler,scale,updateType,extra);
                }
            
        }

                   private static Data _defaultData=new Data(0,false,"","",Vector3.zero,Vector3.zero,Vector3.zero,UpdateType.ShowOnly,"");
