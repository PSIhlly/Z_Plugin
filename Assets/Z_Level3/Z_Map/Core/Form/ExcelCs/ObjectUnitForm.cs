...
namespace Z_Map.Form
{
 ...
 set{
            ...
            public Data(int uid,bool isObstacle,string name,string prefabName,Vector3 pos,Vector3 euler,Vector3 scale,UpdateType updateType,List<int> collidingUnitUid,string extra,bool enteredScene,int minimapIcon):base(uid,name,prefabName,pos,euler,scale,updateType,collidingUnitUid,extra)
            {
            ...
            public void Reset(Data data)
            {
             ...
             this.minimapIcon = data.minimapIcon;
                ...
                {
        return new Data(sameId? uid:uidChain.GetId(),isObstacle,name,prefabName,pos,euler,scale,updateType,collidingUnitUid==null?new List<int>():new List<int>(collidingUnitUid),extra,enteredScene,minimapIcon);
                }
            ...
            public override  void BeforeGet()
            {
                ...
                ObjectUnitForm.beforeGetAction?.Invoke(this);
                   ...
                   private static Data _defaultData=new Data(0,false,"","",Vector3.zero,Vector3.zero,Vector3.zero,UpdateType.ShowOnly,null,"",false,0);
