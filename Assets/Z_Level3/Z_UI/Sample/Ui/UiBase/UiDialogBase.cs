...
namespace Ui.Dialog
{
    ...
    public partial class UiHistoryCtrl:UiCtrl
    {
        ...
        public override void BindHolder(UiHolder uiHolder)
        {
            ...
            view.sub_HistoryItem.BindHolder(uiHolder.subUiHolderLst[0]);
    ...
    public partial class UiDialogView:UiView
    {
        ...
        public UiDialogView(UiHolder uiHolder):base(uiHolder)
        {
            ...
            sub_Func = (UiFuncCtrl) uiHolder.elementTrsLst[7].GetComponent<UiHolder>().ctrl;
            go_title = uiHolder.elementTrsLst[8].gameObject;
            sub_Title = (UiTitleCtrl) uiHolder.elementTrsLst[9].GetComponent<UiHolder>().ctrl;
            go_mainText = uiHolder.elementTrsLst[10].gameObject;
            sub_MainText = (UiMainTextCtrl) uiHolder.elementTrsLst[11].GetComponent<UiHolder>().ctrl;
            go_ProfilePicture = uiHolder.elementTrsLst[12].gameObject;
            sub_ProfilePicture = (UiProfilePictureCtrl) uiHolder.elementTrsLst[13].GetComponent<UiHolder>().ctrl;
            btn_back = uiHolder.elementTrsLst[14].GetComponent<Btn>();
        }
    ...
    public partial class UiDialogCtrl:UiCtrl
    {
        ...
        public override void BindHolder(UiHolder uiHolder)
        {
            ...
            view.sub_History.BindHolder(uiHolder.subUiHolderLst[0]);
            view.sub_MainPicture = new UiMainPictureCtrl();
            view.sub_MainPicture.BindHolder(uiHolder.subUiHolderLst[1]);
            view.sub_Func = new UiFuncCtrl();
            view.sub_Func.BindHolder(uiHolder.subUiHolderLst[2]);
            view.sub_Title = new UiTitleCtrl();
            view.sub_Title.BindHolder(uiHolder.subUiHolderLst[3]);
            view.sub_MainText = new UiMainTextCtrl();
            view.sub_MainText.BindHolder(uiHolder.subUiHolderLst[4]);
            view.sub_ProfilePicture = new UiProfilePictureCtrl();
            view.sub_ProfilePicture.BindHolder(uiHolder.subUiHolderLst[5]);
